...
O gráfico da figura \ref{graf:G12} mostra o desempenho relativo de cada função que compõe a \aspas{verify\_char\_AFD} em relação à própria função \aspas{verify\_char\_AFD}.
...
O gráfico da figura \ref{graf:G13} apresenta, com base em 10 iterações, a média do tempo gasto em segundos por cada função que compõe a \aspas{process\_cell}.
